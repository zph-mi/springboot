...
/*
	...
	public static void main(String[] args) throws Exception {
		...
		//http://127.0.0.1:9200/springbootdemo_test/test/string
//		String s = HTTPPostUtils.sendPostUrl("http://127.0.0.1:9200/springbootdemo_test/test/string", JSONObject.toJSONString("123"),"utf-8");
//		System.out.println("s:"+s);
		...
		String s = new String(decryptData, "utf-8");
